...
var e = Date.now(), 
	...
	c.id = "stats", 
	c.addEventListener("mousedown", function (e) { e.preventDefault(), v(++h % 2) }, !1), 
...
var u = document.createElement("div"); 
	...
	c.appendChild(u); var d = document.createElement("div"); 
	...
	var m = document.createElement("div"); 
		m.id = "ms", m.style.cssText = "padding:0 0 3px 3px;text-align:left;background-color:#020;display:none", 
		c.appendChild(m); 
	var g = document.createElement("div"); 
		g.id = "msText", 
		g.style.cssText = "color:#0f0;font-family:Helvetica,Arial,sans-serif;font-size:9px;font-weight:bold;line-height:15px", 
		g.innerHTML = "MS", m.appendChild(g); 
		...
		return { 
			...
			begin: function () { 
				e = Date.now() }, 
					...
					b(y, Math.min(30, 30 - 30 * (i / 200))), l++, h > t + 1e3 && (s = Math.round(1e3 * l / (h - t)), 
					o = Math.min(o, s), 
					a = Math.max(a, s), 
